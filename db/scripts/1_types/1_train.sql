...
CREATE TYPE TrainStockSegmentInData AS (
    stock_class INT,
    stock_subclass INT,
    stock_number INT,
    stock_cars INT
...
CREATE TYPE TrainLegInData AS (
    user_id INT,
    leg_services TrainServiceInData[],
    service_endpoints TrainServiceEndpointInData[],
    service_calls TrainCallInData[],
...
CREATE TYPE operator_out_data AS (
    operator_id INTEGER,
    operator_code TEXT,
    operator_name TEXT,
    operator_bg TEXT,

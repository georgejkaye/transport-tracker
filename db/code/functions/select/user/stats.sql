...
DROP FUNCTION IF EXISTS create_transport_user_train_operator_all_stat CASCADE;
...
CREATE FUNCTION create_transport_user_train_operator_all_stat ()
RETURNS VOID
LANGUAGE plpgsql
AS
$$
BEGIN
    CREATE TEMP TABLE transport_user_train_operator_all_stat AS
    SELECT
    ...
    FROM (
        ...
        GROUP BY train_operator_or_brand
...
BEGIN
    ...
    FROM (
        ...
        FROM transport_user_train_operator_all_stat
    )
    WHERE rownum = 1;
END;
$$;
...
BEGIN
    SELECT INTO v_transport_user_train_operator_stats
        ...
        (
            transport_user_train_operator_count_all_greatest_stat.count,
            transport_user_train_operator_count_all_greatest_stat.operator_or_brand_id,
            transport_user_train_operator_count_all_greatest_stat.is_brand,
            transport_user_train_operator_count_all_greatest_stat.operator_or_brand_name
        ),
        (
            transport_user_train_operator_count_all_least_stat.count,
            transport_user_train_operator_count_all_least_stat.operator_or_brand_id,
            transport_user_train_operator_count_all_least_stat.is_brand,
            transport_user_train_operator_count_all_least_stat.operator_or_brand_name
        ),
        (
    ...
    INNER JOIN transport_user_train_operator_count_all_stat
        transport_user_train_operator_count_all_greatest_stat
    ON transport_user_train_operator_stat_view.greatest_count
        = transport_user_train_operator_count_all_greatest_stat.count
    INNER JOIN transport_user_train_operator_count_all_stat
        transport_user_train_operator_count_all_least_stat
...
BEGIN
    ...
    PERFORM create_transport_user_train_operator_all_stat();
    ...
    DROP TABLE transport_user_train_operator_all_stat;
...
BEGIN
    ...
    v_train_operator_stats :=
        select_transport_user_train_operator_stats_by_user_id(p_user_id);
    RETURN (
        ...
        (v_train_operator_stats).overall_operator_stats,
        (v_train_operator_stats).year_operator_stats

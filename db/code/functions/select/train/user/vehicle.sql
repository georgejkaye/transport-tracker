DROP FUNCTION IF EXISTS select_transport_user_train_stock_class_by_user_id_and_class;
DROP FUNCTION IF EXISTS select_transport_user_train_stock_class_by_user_id;
DROP FUNCTION IF EXISTS select_transport_user_train_stock_unit_by_user_id_and_number;
DROP FUNCTION IF EXISTS select_transport_user_train_stock_unit_by_user_id;

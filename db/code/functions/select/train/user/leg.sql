...
RETURNS SETOF transport_user_details_train_out_data
LANGUAGE sql
AS
$$
WITH transport_user_train_leg_stat
AS (
    SELECT
        train_leg_id,
...
SELECT
    ...
    (
        transport_user_train_leg_longest_distance.distance,
        transport_user_train_leg_longest_distance.train_leg_id,
        transport_user_train_leg_longest_distance.description
    )::transport_user_details_decimal_stat,
    (
        transport_user_train_leg_shortest_distance.distance,
        transport_user_train_leg_shortest_distance.train_leg_id,
        transport_user_train_leg_shortest_distance.description
    )::transport_user_details_decimal_stat
    -- transport_user_train_leg_stats_view.total_distance,
    -- transport_user_train_leg_stats_view.longest_distance,
    -- transport_user_train_leg_stats_view.shortest_distance,
    -- transport_user_train_leg_stats_view.total_duration,
    -- transport_user_train_leg_stats_view.longest_duration,
    -- transport_user_train_leg_stats_view.shortest_duration,
    -- transport_user_train_leg_stats_view.total_delay,
    -- transport_user_train_leg_stats_view.longest_delay,
    -- transport_user_train_leg_stats_view.shortest_delay
FROM (
    SELECT
        COUNT(*) AS count,
        SUM(distance) AS total_distance,
...
INNER JOIN (
    SELECT
        ...
        description
    FROM transport_user_train_leg_stat
) transport_user_train_leg_longest_distance
ON
    transport_user_train_leg_stats_view.longest_distance
        = transport_user_train_leg_longest_distance.distance
INNER JOIN (
    SELECT
        ...
        description
    FROM transport_user_train_leg_stat
) transport_user_train_leg_shortest_distance
ON
    transport_user_train_leg_stats_view.shortest_distance
        = transport_user_train_leg_shortest_distance.distance
$$;

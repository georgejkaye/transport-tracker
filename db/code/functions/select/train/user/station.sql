...
DROP FUNCTION IF EXISTS select_transport_user_train_stations_by_user_id_and_station_id;
DROP FUNCTION IF EXISTS select_transport_user_train_stations_by_user_id_and_station_crs;

...
DROP DOMAIN IF EXISTS train_station_name_point_in_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_out_data CASCADE;
DROP DOMAIN IF EXISTS train_station_out_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_leg_names_in_data CASCADE;
DROP DOMAIN IF EXISTS train_station_leg_names_in_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_point_out_data CASCADE;
DROP DOMAIN IF EXISTS train_station_point_out_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_points_out_data CASCADE;
DROP DOMAIN IF EXISTS train_station_points_out_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_leg_points_out_data CASCADE;
DROP DOMAIN IF EXISTS train_station_leg_points_out_data_notnull CASCADE;
DROP TYPE IF EXISTS train_station_high_out_data CASCADE;
DROP DOMAIN IF EXISTS train_station_high_out_data_notnull CASCADE;
...
CREATE TYPE train_station_high_out_data AS (
    station_id INTEGER_NOTNULL,
    station_crs TEXT_NOTNULL,
    station_name TEXT_NOTNULL
);

CREATE DOMAIN train_station_high_out_data_notnull
AS train_station_high_out_data NOT NULL;